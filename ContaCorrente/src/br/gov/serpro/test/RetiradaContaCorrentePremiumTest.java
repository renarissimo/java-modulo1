...
public class RetiradaContaCorrentePremiumTest {
    ...
    @Test
    public void devePermitirComSaldoNegativoAteLimiteEspecialPremium() throws Exception {
    ...
    public void naoDevePermitirSaqueSuperiorAoLimiteNegativoEspecialPremium() throws Exception {
